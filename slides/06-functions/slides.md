---
title: 'FP · Lecția 6: Funcții și recursivitate'
info: 'Lecția 6: Funcții și recursivitate — Parametri, scope, stiva de apeluri, recursivitate · Crudu Cristian'
layout: cover
color: blue-light
...
<br/>
<div class="neversink-blue-light-scheme bg-[var(--neversink-admon-bg-color)] p-4 rounded-lg border border-[var(--neversink-admon-border-color)] text-center font-mono text-lg">
