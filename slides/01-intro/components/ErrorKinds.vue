...
const kinds = [
  {
    ...
    text: 'Ați uitat un ; sau o acoladă. Compilerul refuză să traducă și vă arată exact linia.',
    verdict: 'cele mai ușoare',
    level: 1,
  },
  {
  ...
  },
  {
    ...
    text: 'Compilează, pornește, apoi crapă: împărțire la zero, segmentation fault.',
    verdict: 'măcar se vede',
    level: 3,
  },
  {
    ...
    text: 'Rulează, se termină frumos — și afișează un număr greșit. Nimeni nu vă anunță.',
    verdict: 'cele mai periculoase',
    level: 4,
  },
]
</script>
